...
public class Key : MonoBehaviour {
	...
	public GameObject keyPoofPrefabLocation;
	...
	void Update () {
		...
		key.transform.Rotate(0 , 0, 90f * Time.deltaTime );
	...
	public void OnKeyClicked () {
		...
		Door.Unlock ();
		Instantiate(keyPoofPrefab, keyPoofPrefabLocation.transform.position, keyPoofPrefabLocation.transform.rotation );
